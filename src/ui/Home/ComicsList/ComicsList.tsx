...
export const ComicsList = () => {
  ...
  React.useEffect(() => {
    async function fetchCharacters() {
      setCharacters(await characterService(apiCharacterRepository).all())
    }
  ...
  React.useEffect(() => {
    async function fetchComics() {
      setComics(await comicService(apiComicRepository).commonComics(firstCharacterFilter, secondCharacterFilter))
    }
